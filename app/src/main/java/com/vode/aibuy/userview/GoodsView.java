...
public class GoodsView extends LinearLayout {
    ...
    private void init(AttributeSet attrs){
        ...
        int color = typedArray.getColor(R.styleable.GoodsView_color, getResources().getColor(R.color.red));
        ...
        this.left.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewClickListener != null) {
                    viewClickListener.onLeftClick();
                }else {
                    defaultViewClicker.onLeftClick();
                }
        ...
        center.setBackgroundResource(R.color.bgwhite);
        /*用于避免三个控件一般大*/
        balanceFactor = 20;
        ...
        right.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewClickListener != null) {
                    viewClickListener.onRightClick();
                }else {
                    defaultViewClicker.onRightClick();
                }
